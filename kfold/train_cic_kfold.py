...
from data.preprocess_cic import *
...
##### Load Data #####
data_dir='data/cicids17/split/'
train=pd.read_csv(data_dir+f'/train.csv')
val=pd.read_csv(data_dir+f'/val.csv')
...
log_name="perf_results/cic_train_perf_fixed.txt"
...
for train_index, val_index in kf.split(train):
    ...
    eval_dataloader = DataLoader(x_train_v_cuda, sampler=eval_sampler, batch_size=10000)
    ...
    if args.dist_cos:
        ...
        pred_val,val_loss=get_model_preds(model,eval_dataloader)
        print("Inference T-Val Complete")
    ...
    test_dataloader = DataLoader(x_val_cuda, sampler=test_sampler,batch_size=10000,num_workers=2)
...
if args.dist_cos:
    joblib.dump(best_scaler, "./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}_cos.scaler".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed)) 
    pickle.dump(best_num_desc,open("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}_cos.numdesc".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed), 'wb'))
    # best_num_desc.to_csv(,header=None,index=None)
    with open("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}_cos.pt".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed), "wb") as f:
        torch.save(
            {
    ...
    joblib.dump(best_scaler, "./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}.scaler".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed)) 
    pickle.dump(best_num_desc,open("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}.numdesc".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed), 'wb'))
    # best_num_desc.to_csv(,header=None,index=None)
    with open("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}.pt".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed), "wb") as f:
        torch.save(
            {
...
print("\nTrain Complete")
if args.dist_cos:
    best_num_desc=pickle.load(open("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}_cos.numdesc".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed), 'rb'))
    best_scaler=joblib.load("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}_cos.scaler".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed))
    with open("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}_cos.th".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed),'w') as f:
        f.write(f'{str(best_mean)}\n{str(best_std)}\n{str(best_z)}')
else:
    best_num_desc=pickle.load(open("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}.numdesc".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed), 'rb'))
    best_scaler=joblib.load("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}.scaler".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed))
    with open("./weights_{}_{}_{}/cic_{}_{}_{}_{}_{}.th".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed),'w') as f:
        f.write(f'{str(best_mean)}\n{str(best_std)}\n{str(best_z)}')
...
if args.dist_cos:
    log_name=f"perf_results/cic_{args.size}_{args.num_layers}_cos.csv"
else:
    log_name=f"perf_results/cic_{args.size}_{args.num_layers}.csv"
