...
from data.preprocess_iotbotnet import *
...
log_name="perf_results/iotbotnet_train_perf_fixed.txt"
...
joblib.dump(best_scaler, "./weights_{}_{}_{}/iotbotnet_{}_{}_{}_{}_{}.scaler".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed)) 
# best_num_desc.to_csv(,header=None,index=None)
with open("./weights_{}_{}_{}/iotbotnet_{}_{}_{}_{}_{}.pt".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed), "wb") as f:
    torch.save(
        {
...
best_scaler=joblib.load("./weights_{}_{}_{}/iotbotnet_{}_{}_{}_{}_{}.scaler".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed))
with open("./weights_{}_{}_{}/iotbotnet_{}_{}_{}_{}_{}.th".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed),'w') as f:
...
log_name=f"perf_results/iotbotnet_{args.size}_{args.num_layers}.csv"
