...
if balanced_test:
    ...
    log_name="perf_results/iotid20_test_perf_bal.txt"
    print("Balanced")
else:
    print("Not Balanced")
    log_name="perf_results/iotid20_test_perf.txt"
...
with open("./weights_{}/iotid20_{}_{}_{}_{}_{}.pt".format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed), "rb") as f:
