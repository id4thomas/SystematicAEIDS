...
parser.add_argument("--data", default="nsl", type=str,
                        help="Dataset: nsl,cic,iotbotnet")
...
wandb_key={
    'nsl':'svcc-nslkdd',
    'cic':'svcc-cicids17',
    'iotbotnet':'svcc-iotbotnet',
}
wandb.init(project=wandb_key[args.data])
...
##### Load Data #####
data=load_data(dataset=args.data)
...
model_desc='AE{}-{}_{}_{}_{}'.format(model_dec_type,size_val,args.dec_rate,args.l_dim,args.num_layers)
...
#ex) perf_results/nsl_train_log_fixed.txt
log_file=f"perf_results/{args.data}_train_log_{model_dec_type}.txt"
...
with open("./"+weight_folder+f"/{args.data}_{size_val}_{args.l_dim}_{args.epoch}_{args.batch_size}_{args.seed}.pt","wb") as f:
    torch.save(
        {
...
# with open("./weights_{}_{}_{}/{}_{}_{}_{}_{}_{}.pt".format(args.num_layers,model_dec_type,args.dec_rate,size_val,args.l_dim,args.epoch,args.batch_size,args.seed), "wb") as f:
#     torch.save(
#         {
#             "state_l2": model_best['state_l2'],
#             "state_cos": model_best['state_cos'],
