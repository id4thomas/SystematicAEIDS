...
print("\nTrain Complete")
if not os.path.isfile("perf_results/iotid20_train_log.txt"):
     with open("perf_results/iotid20_train_log.txt", "a") as myfile:
...
with open("./weights_{}/iotid20_{}_{}_{}_{}_{}.pt".format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed), "wb") as f:
    torch.save(
        {
...
loss_fig.savefig('./loss_plot/iotid20_{}_{}_{}_{}_{}_{}.png'.format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed))

# #AUC Plot
auc_fig=plot_auc(val_hist['auc_l2'])
auc_fig.savefig('./auc_plot/iotid20_l2_{}_{}_{}_{}_{}.png'.format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed))

auc_fig=plot_auc(val_hist['auc_cos'])
auc_fig.savefig('./auc_plot/iotid20_cos_{}_{}_{}_{}_{}.png'.format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed))
exit()
