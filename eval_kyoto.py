...
# import wandb
# wandb.init(project="svcc-kyotoids17")
...
x_test,y_test=get_hdf5_data(data_path+'val.hdf5',labeled=True)
print("Val: Normal:{}, Atk:{}".format(x_val[y_val==SAFE].shape[0],x_val[y_val!=SAFE].shape[0]))
print("Test: Normal:{}, Atk:{}".format(x_test[y_test==SAFE].shape[0],x_test[y_test!=SAFE].shape[0]))
...
if balanced_test:
    ...
    print("Not Balanced")
    log_name="perf_results/kyoto_test_perf.txt"
...
with open("./weights_{}/kyoto_{}_{}_{}_{}_{}.pt".format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed), "rb") as f:
