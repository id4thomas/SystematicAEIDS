...
if balanced_test:
    ...
    log_name="perf_results/iotbotnet_test_perf_bal.txt"
    print("Balanced")
else:
    print("Not Balanced")
    log_name="perf_results/iotbotnet_test_perf.txt"
...
if args.dec:
    ...
    for i in range(0,args.num_layers):
        ...
        # layers.append(int(x_test.shape[1]*layer_dec_rates[i]))
        #Decreasing Rate Arg
        layers.append(int(x_test.shape[1]*args.dec_rate**(i+1)))
...
with open("./weights_{}/iotbotnet_{}_{}_{}_{}_{}.pt".format(args.num_layers,args.dec_rate,args.l_dim,args.epoch,args.batch_size,args.seed), "rb") as f:
...
test_dataloader = DataLoader(x_test_cuda, sampler=test_sampler, batch_size=x_test.shape[0])#args.batch_size)
