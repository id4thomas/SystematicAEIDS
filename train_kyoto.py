...
print("Train: Normal:{}, Atk:{}".format(x_train[y_train==SAFE].shape[0],x_train[y_train!=SAFE].shape[0]))
...
print("\nTrain Complete")
if not os.path.isfile("perf_results/kyoto_train_log.txt"):
     with open("perf_results/kyoto_train_log.txt", "a") as myfile:
...
with open("./weights_{}/kyoto_{}_{}_{}_{}_{}.pt".format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed), "wb") as f:
    torch.save(
        {
...
loss_fig.savefig('./loss_plot/kyoto_{}_{}_{}_{}_{}_{}.png'.format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed))

# #AUC Plot
auc_fig=plot_auc(val_hist['auc_l2'])
auc_fig.savefig('./auc_plot/kyoto_l2_{}_{}_{}_{}_{}.png'.format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed))

auc_fig=plot_auc(val_hist['auc_cos'])
auc_fig.savefig('./auc_plot/kyoto_cos_{}_{}_{}_{}_{}.png'.format(args.num_layers,args.size,args.l_dim,args.epoch,args.batch_size,args.seed))
exit()
