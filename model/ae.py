...
class AE(nn.Module):
    def __init__(self,model_config):
        ...
        self.encoder.add_module("e_in_actv",nn.LeakyReLU())
        ...
        self.decoder.add_module("d_out",nn.Linear(layer_dims[num_layers-1],self.data_dim))
        self.decoder.add_module("d_out_actv",nn.Sigmoid())
